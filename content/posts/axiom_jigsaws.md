...
Elegantly, these three simple claims allow us to deduce many, many more of the features of probabilities that we would like to be true. You can try and prove some yourself or check the proofs on wikipedia.
...
To understand this problem better, I tried to construct a monster: an example of a probability field which fits Kolmogorov's five axioms but clearly doesn't work the way we would want probabilities to work.
